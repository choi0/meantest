/**
 * Created by ypatel11 on 8/5/2016.
 */
...
module.exports = {
    /*mongo: {
        dbUrl: 'https://api.mlab.com/api/1/',            // The base url of the MongoLab DB server
        apiKey: '9J6qlmrcjD68OIPgRx2Emp5OnxFRQCJ-'                 // Our MongoLab API key
    },
    security: {
        dbName: 'ui_test_db',                                   // The name of database that contains the security information
